					...
					<div class="span12">
						<div class="widget-box">
							...
							<div class="widget-content nopadding">
								<form action="/shadow/mast/Goods/operate/type/edit/id/1.html" method="post" class="myform form-horizontal">
...
$(".myform").submit(function(){
	...
	if(stat==0){
			return false;
			 ...
			 $.post("/shadow/mast/Goods/operate/type/edit/id/1.html",$(this).serialize()).success(function(data){
				 if (data.status==1) {
