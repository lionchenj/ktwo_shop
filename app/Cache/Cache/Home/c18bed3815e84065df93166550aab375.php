...
<head>
	...
	<script type="text/javascript" src="/tcm/template/Tcm/js/jquery.validate.min.js"></script>
	<script type="text/javascript" src="/tcm/template/Tcm/js/common.js"></script>
</head>
<body class="bg-white" style="min-height: 100%;">
	<div class="form-container">
		<div class="form-img">
			<img src="/tcm/template/Tcm/images/tianfuan.jpg">
		</div>
