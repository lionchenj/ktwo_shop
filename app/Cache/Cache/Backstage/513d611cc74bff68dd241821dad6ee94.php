					...
					<div class="span12">
						<div class="widget-box">
							...
							<div class="widget-content nopadding">
								<form action="/tcm/Admin/operate/type/edit/id/22.html" method="post" class="myform form-horizontal">								
									<div class="control-group">
										<label class="control-label">登陆账号:</label>											
										<div class="controls">
										<input name="userid" type="text" class="span3 hide" placeholder="登陆账号" value="<?php echo ($data["userid"]); ?>" />
										<input name="username" type="text" class="span3" placeholder="登陆账号"  value="<?php echo ($data["username"]); ?>"   disabled/> 
									...
									<div class="control-group">
										...
										<div class="controls ">									
											<input type="text" name="email"  class="span3" placeholder="绑定邮箱"   class="span2"  value="<?php echo ($data["email"]); ?>" /><div></div>														
										</div>
									</div>
									<div class="control-group">
										...
										<div class="controls">
											...
											<?php if(is_array($group_list)): foreach($group_list as $key=>$vo): ?><option <?php if(($data['groupid']) == $vo['id']): ?>selected="selected"<?php endif; ?> value ="<?php echo ($vo["id"]); ?>"><?php echo ($vo["title"]); ?></option><?php endforeach; endif; ?>
											</select>
										</div>								
										</div>									
