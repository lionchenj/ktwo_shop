...
<div id="content">
  <div id="content-header">
    <div id="breadcrumb"> <a href="/zhouzf/www/tcm/index.html" title="Go to Home" class="tip-bottom"><i class="icon-home"></i> 首页</a> <a href="/zhouzf/www/tcm/classify.html" class="current">商品分类</a> </div>
          ...
          <div class="widget-content">
            <div class="row-fluid">
              <div class="span12 category">
			   <div class="span12" style="background-color: #e5e5e5;"> <span class="btn ajax-post confirm" onclick="javascript:window.location.href='<?php echo U('add');?>';"  style="margin:5px;padding:8px 12px;color:#333;background-color:#fff;border: 1px solid #ddd;"> <i class="icon-plus"></i> 新增顶级分类</span></div>
			  ...
			  <?php echo R('Classify/tree', array($tree));?>
              </div>
            </div></div></div>
