					...
					<div class="span12">
						<div class="widget-box">
							...
							<div class="widget-content nopadding">
								<form action="/tcm/depositcard.html" method="get" class="myform form-horizontal">
...
<div class="box"></div>
	<div class="box1">	
           <form class="form-vertical" action="/tcm/depositcard.html"> 
