					...
					<div class="span12">
						<div class="widget-box">
							...
							<div class="widget-content nopadding">
								<form action="/tcm/Offlineorder/operate/id/x20181204745722/type/edit.html" method="get" class="myform form-horizontal">
									...
									<div class="form-actions">
										<button type="button" id="confirm_submit" class="btn btn-success ajax-post" url="" target-form="myform">保存</button>
											<button type="button" class="btn btn-warning"  onclick="window.location.href='/tcm/offlineorder.html'">返回</button>
									</div>
								</form>
							</div>
						</div>						
...
<div class="box">
	...
	<div class="box1">	
           <form class="form-vertical" action="/tcm/Offlineorder/operate/id/x20181204745722/type/edit.html"> 
...
<script>
		...
		$('#submit_deposit').click(function(){										
			...
			var url="/tcm/Offlineorder/operate/id/x20181204745722/type/edit.html";
			$.post(url,data).success(function(data){
				if (data.status==1) {
					$('.box1').hide();
					$('.box').hide();
