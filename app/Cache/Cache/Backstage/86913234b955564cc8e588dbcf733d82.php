					...
					<div class="span12">
						<div class="widget-box">
							...
							<div class="widget-content nopadding">
								<form action="/zhouzf/www/tcm/Goods/add.html" method="post" class="myform form-horizontal">
                                    ...
                                    <div class="control-group">
                                        ...
                                        <div class="controls">
										<img class="goods_img" style="width:150px" src="/zhouzf/www/tcm/template/Maruti/images/add.jpg" onclick="getElementById('inputfile').click()">
										...
										<div class="controls ">
											...
											<?php if(is_array($classify)): foreach($classify as $key=>$list): ?><dl>
													...
													<?php if(!empty($list['_'])): if(is_array($list['_'])): foreach($list['_'] as $key_2=>$list_): if(($key_2) > "0"): ?><dd>
														<span class="" <?php if(!empty($list_['_'])): ?>data-tab<?php endif; ?>" data-id="<?php echo ($list_["id"]); ?>"><?php echo ($list_["title"]); ?></span>
												...
												<!-- <div class="gift-c1">
													<label class="inlineLabel"><input type="checkbox" id="gift-box" name="out_type_2" >兑换券</label>																									
														<div id="gift-item" <?php if(!empty($info["least"])): ?>style="display:block;"<?php else: ?>style="display:none;"<?php endif; ?>>
															...
															<?php if(is_array($card)): foreach($card as $key=>$vo): ?><option value="<?php echo ($vo["id"]); ?>"><?php echo ($vo["name"]); ?></option><?php endforeach; endif; ?>
															</select>
														</div>																																							
												</div> -->
										</div>									
