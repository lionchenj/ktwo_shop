...
<div id="content">
  ...
  <div class="container-fluid">
							...
							<div class="widget-content nopadding">
								<form action="<?php echo U('index');?>" method="get" class="form-horizontal">
									...
									<div class="control-group">
										...
										<?php else: ?>
										<label><input type="checkbox" name="status[]" value="2"/>已支付</label><?php endif; endif; ?>
										</div>
									</div>                             
                                    <div class="control-group">
        ...
        <div class="widget-box">
		  ...
		  <span class="btn ajax-post confirm" url="<?php echo U('operate',array('type'=>'status'));?>" target-form="ids" style="padding:8px 12px;color:#333;background-color:#fff;border: 1px solid #ddd;"> <i class="icon-trash"></i> 批量删除</span>
