...
<div id="content">
  <div id="content-header">
    <div id="breadcrumb"> <a href="/tcm/index.html" title="Go to Home" class="tip-bottom"><i class="icon-home"></i> 首页</a> <a href="/tcm/goods.html" class="current">卡券管理</a> </div>
  ...
  <div class="container-fluid">
        <div class="widget-box">
		  ...
		  <?php if(($_Auth) == "1"): ?><span class="btn" onclick=" window.location.href='<?php echo U('operate',array('type'=>'select_type'));?>'" style="padding:8px 12px;color:#333;background-color:#fff;border: 1px solid #ddd;"> <i class="icon-plus"></i> 新建卡券</span><?php endif; ?>
            <table class="table table-bordered table-striped with-check">
              ...
              <tbody>
				...
				<?php if(is_array($_list)): foreach($_list as $key=>$vo): ?><td><input type="checkbox" class="ids" name="id[]" value="<?php echo ($vo["id"]); ?>"  /></td>
				  ...
				  <?php if(($vo['status']) == "1"): ?>已过审<?php endif; ?>
				  </td>
				  <?php if(($_Auth) == "1"): ?><td>
					<span class="fr">
					<?php if($vo["type"] == '兑换券'): ?><!--<a class="btn btn-success btn-mini" href="<?php echo U('operate',array('type'=>'get_card','card_id'=>$vo['card_id']));?>">领券</a>--><?php endif; ?>
					<a class="btn btn-primary btn-mini" href="<?php echo U('operate',array('type'=>'edit','card_type'=>$vo['type'],'id'=>$vo['id']));?>">详情</a>
					<a class="btn btn-danger btn-mini ajax-get" href="<?php echo U('operate',array('type'=>del,'id'=>$vo['card_id']));?>">删除</a>
					</span>
					</td><?php endif; ?>
