...
function getUserInfoShop($data){
	    $postdata = http_build_query($data);
	    $url = "https://dev170.weibanker.cn/hongjh/www/jinfeng/api?url=getUserInfoShop";
	    //$url ="http://127.0.0.1/jinfeng/api?url=getUserInfoShop";
		$options = array(
		    'http' => array(
		      'method' => 'POST',
...
function buyScoreShop($data){
	    $postdata = http_build_query($data);
	    $url = "https://dev170.weibanker.cn/hongjh/www/jinfeng/api?url=buyScoreShop";
	    //$url = "http://127.0.0.1/jinfeng/api?url=buyScoreShop";
		$options = array(
		    'http' => array(
		      'method' => 'POST',
		      'header' => 'Content-type:application/x-www-form-urlencoded',
