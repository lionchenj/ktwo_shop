  ...
  <div class="row-fluid" id="select_map">
						...
						<div class="widget-box">
							...
							<div class="widget-content nopadding">
								<form action="<?php echo U('index');?>" method="get" class="form-horizontal">                        
									...
									<?php if(!empty($user)): ?><div class="control-group">
                                        <label class="control-label">操作账号</label>
                                        <div class="controls">
                                          <select name="userid" id="userid" style="width:200px">
											<option value ="0">请选择</option>
											<?php if(is_array($user)): foreach($user as $key=>$_list): ?><option value ="<?php echo ($_list["userid"]); ?>" <?php if(($_GET['userid']) == $_list["userid"]): ?>selected="selected"<?php endif; ?>><?php echo ($_list["username"]); ?></option><?php endforeach; endif; ?>
											</select>
                                        </div>
                                    </div><?php endif; ?>
									
									<?php if(!empty($goods)): ?><div class="control-group">
                                        <label class="control-label">商品</label>
                                        <div class="controls">
                                          <select name="goodsid"  style="width:150px">
											<option value ="0">请选择</option>
											<?php if(is_array($goods)): foreach($goods as $key=>$_list): ?><option value ="<?php echo ($_list["goodsid"]); ?>" <?php if(($_GET['goodsid']) == $_list["goodsid"]): ?>selected="selected"<?php endif; ?>><?php echo ($_list["goodsname"]); ?></option><?php endforeach; endif; ?>
											</select>
                                        </div>
                                    </div><?php endif; ?>
									...
									<div class="form-actions">
										...
										<button type="button" class="btn" ><a href="/zhouzf/www/tcm/count.html" >清空</a></button>
									</div>
								</form>
							</div>
						</div>						
   ...
   <div class="row-fluid">
      ...
      <li>
        ...
        <div class="right"> <strong><?php echo ($order_true_num+$offline_order_true_num); ?></strong> 成交量 </div>
      </li>
      <li>
        <div class="left peity_bar_bad"><span>3,5,9,7,12,20,10</span></div>
        <div class="right" style="width:150px"> <strong><?php echo ($order_true_money); ?></strong> 积分交易额 </div>
      </li>
	  </ul>
          ...
          <div class="widget-content">
            <div class="row-fluid">
              <div class="span12">
				...
				<!-- <div class="row-fluid">
				<?php if(!empty($offline_order_list)): ?><div class="span4">
						<div class="widget-box">
							<div class="widget-title">
								<span class="icon">
									<i class="icon-eye-open"></i>
							...
							<div class="widget-content nopadding">
								<table class="table table-bordered">
									...
									<tbody>
									<?php if(is_array($offline_order_list)): foreach($offline_order_list as $key=>$vo1): ?><tr>
											<td><?php echo ($vo1["time"]); ?></td>
											<td><?php echo ($vo1["num"]); ?></td>
										</tr><?php endforeach; endif; ?>
									</tbody>
					...
					<?php if(!empty($offline_order_true_list)): ?><div class="span4">
						<div class="widget-box">
							<div class="widget-title">
								<span class="icon">
									<i class="icon-arrow-right"></i>
							...
							<div class="widget-content nopadding">
								<table class="table table-bordered">
									...
									<tbody>
									<?php if(is_array($offline_order_true_list)): foreach($offline_order_true_list as $key=>$vo2): ?><tr>
											<td><?php echo ($vo2["time"]); ?></td>
											<td><?php echo ($vo2["num"]); ?></td>
										</tr><?php endforeach; endif; ?>
									</tbody>
					...
					<?php if(!empty($offline_order_money_list)): ?><div class="span4">
						<div class="widget-box">
							<div class="widget-title">
								<span class="icon">
									<i class="icon-file"></i>
							...
							<div class="widget-content nopadding">
								<table class="table table-bordered">
									...
									<tbody>
										<?php if(is_array($offline_order_money_list)): foreach($offline_order_money_list as $key=>$vo3): ?><tr>
											<td><?php echo ($vo3["time"]); ?></td>
											<td><?php echo ($vo3["num"]); ?></td>
										</tr><?php endforeach; endif; ?>
									</tbody>
						...
						<div class="widget-box">
							...
							<div class="widget-content nopadding">
								<table class="table table-bordered">
									...
									<tbody>
									<?php if(is_array($member_list)): foreach($member_list as $key=>$vo4): ?><tr>
											<td><?php echo ($vo4["time"]); ?></td>
						...
						<div class="widget-box">
							...
							<div class="widget-content nopadding">
								<table class="table table-bordered">
									...
									<tbody>
									<?php if(is_array($recharge_data)): foreach($recharge_data as $key=>$vo5): ?><tr>
											<td><?php echo ($vo5["time"]); ?></td>
						...
						<div class="widget-box">
							...
							<div class="widget-content nopadding">
								<table class="table table-bordered">
									...
									<tbody>
									<?php if(is_array($recharge_money)): foreach($recharge_money as $key=>$vo6): ?><tr>
											<td><?php echo ($vo6["time"]); ?></td>
											<td><?php echo ($vo6["money"]); ?></td>
										</tr><?php endforeach; endif; ?>
									</tbody>
								</table>
							</div>
...
$("#chart_update").click(function(){
	var url="/zhouzf/www/tcm/count.html";
