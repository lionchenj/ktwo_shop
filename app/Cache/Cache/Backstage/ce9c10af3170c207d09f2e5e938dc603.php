		...
		<div id="content">
			<div id="content-header">
                <div id="breadcrumb">
                    ...
                    <a href="/tcm/classify.html" class="tip-bottom">分类管理</a>
					 <a  class="tip-bottom"><?php echo ($meta_title); ?></a>
                </div>
					...
					<div class="span12">
						<div class="widget-box">
							...
							<div class="widget-content nopadding">
								<form id="updateform" action="/tcm/Classify/add.html" method="POST" class="form-horizontal">
									...
									<div class="control-group">
										...
										<div class="controls"><input name="description" type="text" class="span20" placeholder="描述(选填)" value="<?php echo ($array["description"]); ?>" />
										<div><error class="color-red hidden"></error></div></div>
