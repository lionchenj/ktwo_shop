					...
					<div class="span12">
						<div class="widget-box">
							...
							<div class="widget-content nopadding">
								<form action="/tcm/depositspecial.html" method="get" class="myform form-horizontal">
									...
									<div class="control-group" id="total_money"  >
                                        ...
                                        <div class="controls">
											<input type="text" name="total" placeholder="充值金额" class="span3">
											<div><error class="color-red hidden"></error></div> 
                                        </div>
                                    </div>
...
<div class="box"></div>
	<div class="box1">	
           <form  class="form-vertical" action="/tcm/depositspecial.html"> 
  ...
  switch(name)
  {
	...
	break;
		...
		$('#submit_deposit').click(function(){
			...
			var url="/tcm/depositspecial.html";
