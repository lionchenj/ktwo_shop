...
<div id="content">
   <div id="content-header">
    <div id="breadcrumb"> <a href="/zhouzf/www/tcm/index.html" title="Go to Home" class="tip-bottom"><i class="icon-home"></i> 首页</a> <a href="/zhouzf/www/tcm/auth.html" class="current">权限管理</a> </div>
  ...
  <div class="container-fluid">
        <div class="widget-box">
		  ...
		  <?php if(($_Auth) == "1"): ?><span class="btn" onclick=" window.location.href='<?php echo U('operate',array('type'=>'add'));?>'" style="padding:8px 12px;color:#333;background-color:#fff;border: 1px solid #ddd;"> <i class="icon-plus"></i> 新建角色</span><?php endif; ?>
            <table class="table table-bordered table-striped with-check">
              ...
              <tbody>				
				...
				<?php if(is_array($_list)): foreach($_list as $key=>$vo): ?><td><input type="checkbox" class="ids" name="id[]" value="<?php echo ($vo["id"]); ?>"  /></td>
				  ...
				  <?php if(($_Auth) == "1"): ?><td>
					<span class="fr">	
					<?php if($vo['id'] > 10): ?><a class="btn btn-success btn-mini" href="<?php echo U('operate',array('type'=>'auth','id'=>$vo['id']));?>">权限分配</a>
					<a class="btn btn-primary btn-mini" href="<?php echo U('operate',array('type'=>'edit','id'=>$vo['id']));?>">修改</a>
					<a class="btn btn-danger btn-mini ajax-get" href="<?php echo U('operate',array('type'=>'status','id'=>$vo['id']));?>">删除</a><?php endif; ?>
					</span>
					</td><?php endif; ?>
