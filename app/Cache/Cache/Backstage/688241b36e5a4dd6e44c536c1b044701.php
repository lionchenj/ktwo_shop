					...
					<div class="span12">
						<div class="widget-box">
							...
							<div class="widget-content nopadding">
								<form action="/tcm/Membercard/operate/type/edit/id/1000001.html" method="get" class="myform form-horizontal">	
									<div class="control-group">
										<label class="control-label">会员卡号:</label>											
										<div class="controls"><input name="id" type="text" class="span3" placeholder="会员卡号" value="<?php echo ($info["id"]); ?>" disabled/> 
										<div id="error_name" ><error class="color-red hidden"></error></div>
										</div>										
									</div>										
									<div class="control-group">
										<label class="control-label">会员卡金额:</label>											
										<div class="controls"><input name="money" type="text" class="span3 int" placeholder="会员卡金额" value="<?php echo ($info["money"]); ?>" />
										<div id="error_name" ><error class="color-red hidden"></error></div>
										</div>
									...
									<div class="form-actions">
										<button type="button" id="confirm_submit" class="btn btn-success ajax-post" url="" target-form="myform">保存</button>
											<button type="button" class="btn btn-warning"  onclick="window.location.href='/tcm/membercard.html'">返回</button>
									</div>
								</form>
							</div>
						</div>						
...
<script>
		...
		$('#confirm_submit').click(function(){
			...
			if(stat){
				var url='/tcm/Membercard/operate/type/edit/id/1000001.html';		
				var data={};
				data['money']=money;				
